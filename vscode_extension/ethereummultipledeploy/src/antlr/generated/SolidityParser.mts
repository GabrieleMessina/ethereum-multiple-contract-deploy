...
import { SolidityParserListener } from "./SolidityParserListener.mjs";
import { SolidityParserVisitor } from "./SolidityParserVisitor.mjs";
...
export class AddressPayableContext extends antlr.ParserRuleContext {
    ...
    public override enterRule(listener: SolidityParserListener): void {
        if(listener.enterAddressPayable) {
             listener.enterAddressPayable(this);
        }
    }
    public override exitRule(listener: SolidityParserListener): void {
        if(listener.exitAddressPayable) {
             listener.exitAddressPayable(this);
        }
    }
    public override accept<Result>(visitor: SolidityParserVisitor<Result>): Result | null {
        if (visitor.visitAddressPayable) {
            return visitor.visitAddressPayable(this);
        } else {
            return visitor.visitChildren(this);
        }
    }
...
export class YulboolContext extends antlr.ParserRuleContext {
    ...
    public override enterRule(listener: SolidityParserListener): void {
        if(listener.enterYulbool) {
             listener.enterYulbool(this);
        }
    }
    public override exitRule(listener: SolidityParserListener): void {
        if(listener.exitYulbool) {
             listener.exitYulbool(this);
        }
    }
    public override accept<Result>(visitor: SolidityParserVisitor<Result>): Result | null {
        if (visitor.visitYulbool) {
            return visitor.visitYulbool(this);
        } else {
            return visitor.visitChildren(this);
        }
    }
